...
**Status at 2026-08-24 — 6 of 10 closed.**
...
The four that remain open need a **human decision or a human visit**, not a code change:
1 needs a source registered, 2 needs a broader adversarial run owned by Quality, 4 needs a
person to open a page that refuses robots, and 9 needs a teammate's signature.
